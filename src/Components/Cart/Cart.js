...
const Cart = () => {
    ...
    const handleClickMP = () => { // fetch("https://backend.sib.com.uy/create_preference", {
                            ...
                            <div> {
                                !formFilled ? (
                                    <div className='formInCart'>
                                        <FormCompra onClickSiguiente={siguienteClickHandler}
                                            envio={envio} />
                                    </div>
                                ) : (
                                    <div> {
                                        retiro === 'Domicilio' ? (
                                            <div className='formInCart'>
                                                <FormCompraDireccion onClickSiguiente={formDirectionIsFilled}
                                                    isHidden={formDirectionFilled} /> {
                                                    formDirectionFilled && (
                                                        <div>
                                                            <ResumenDeCompra pagoMP={pagoMP}
                                                                pagoET={pagoET}
